...
void AIComponent::judgeTrackMatch(const QString& trackJson, const QString& candidatesJson)
{
  ...
  QString systemPrompt =
    ...
    "When the YouTube entry has an artist or channel hint, the candidate artist must match on some level. "
    "Do not match on title words alone. A common word in the title, such as \"you\", is not enough.\n"
    "Use artist evidence flexibly because YouTube may use a channel/uploader name, but reject candidates "
    "whose artists are unrelated to the YouTube artist/channel hint.\n"
